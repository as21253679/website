    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <h2 class="sub-header">景點項目
            <span style="float:right">
              <!-- 新增 Task 按鈕 -->
              <form action="back-attractions_create.html" method="POST" class="form-inline">
...
while($row = mysql_fetch_array($result)){//印出資料
	...
	$htm = "<td><form action='enable.php' method='POST' class='form-inline'>
                  ...
                  <td>
                    <!-- 修改 Task 按鈕 -->
                    <form action='update_post.php?id=".$row['postID']."' method='POST' class='form-inline'>
